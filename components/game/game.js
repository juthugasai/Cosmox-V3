...
import { Dimensions, Alert, Touchable } from 'react-native'
...
export default class App extends PureComponent {
  ...
  gameOver() {
    ...
    /*Alert.alert(
      ...
      'The aliens have won!',
      [
        { text: 'Exit', onPress: () => this.props.navigation.navigate('Home'), style: 'cancel' },
        { text: 'Play Again', onPress: () => this.initGame() }
      ],
      { cancelable: false })*/
  }
